...
export default function EditMealModal({
  ...
  const fetchEditMeal = async (editData: EditMealSchemaType) => {
    try {
      // Filtrar propriedades não preenchidas
      // Object.entries(editData).filter(...)    -> vai retornar o array onde o value não for undefined, null ou ''
      // Object.fromEntries(...)    -> vai retransformar o array de ['key', 'value'] em um objeto novamente
      const dataWithoutEmptyProperties = Object.fromEntries(
      ...
      const { date, time, ...rest } = dataWithoutEmptyProperties
